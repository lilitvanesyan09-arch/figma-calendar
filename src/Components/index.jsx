            ...
            <div className="all">
                ...
                <div className="rigth">
                    <div className="inputs">
                        <input type="text" className="inp1" placeholder="Type Title of task" />
                        <input type="text" className="inp2" placeholder="Detail of your task" />
                        <button>+</button>
                    </div>
                    ...
                    <div>
                        <div className="selectors">
                            <select name="cars" id="cars">
                                <option value="volvo">By Category</option>
                            </select>
                            <select>
                                <option value="volvo">By priority</option>
                            </select>
                        </div>
                    </div>

                    <div className="beige-divs">
                        <div className="beige-div">
                            <div>
                                ...
                                <div><h3>Start date: 07-07-2023</h3></div>
                            </div>
                            <div className="svgs">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M560-80v-123l221-220q9-9 20-13t22-4q12 0 23 4.5t20 13.5l37 37q8 9 12.5 20t4.5 22q0 11-4 22.5T903-300L683-80H560Zm300-263-37-37 37 37ZM620-140h38l121-122-18-19-19-18-122 121v38ZM240-80q-33 0-56.5-23.5T160-160v-640q0-33 23.5-56.5T240-880h320l240 240v120h-80v-80H520v-200H240v640h240v80H240Zm280-400Zm241 199-19-18 37 37-18-19Z" /></svg>
